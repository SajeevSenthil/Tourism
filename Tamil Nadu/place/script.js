...
const exploreBgVideo = document.getElementById('explore-bg-video');
...
function resizeVideo() {
    const videoRatio = exploreBgVideo.videoWidth / exploreBgVideo.videoHeight;
    const windowRatio = window.innerWidth / window.innerHeight;

    if (videoRatio > windowRatio) {
        exploreBgVideo.style.width = '100vw';
        exploreBgVideo.style.height = 'auto';
    } else {
        exploreBgVideo.style.width = 'auto';
        exploreBgVideo.style.height = '100vh';
    }
}
// Light/Dark toggle
